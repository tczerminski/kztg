...
var translations = {
  pl: {
    "page.title":
      "Kościół Zmartwychwstałego w Tarnowskich Górach | Kościół Zmartwychwstałego w Tarnowskich Górach",
    "site.name": "Kościół Zmartwychwstałego w Tarnowskich Górach",
    "site.name.mobile":
      "Kościół Zmartwychwstałego<br />w<br />Tarnowskich Górach",
    "radio.label": "Radio Internetowe",
    "radio.heading": "Słuchaj o dowolnej porze",
    "radio.desc":
      "Muzyka uwielbieniowa, kazania oraz transmisje na żywo z Tarnowskich Gór. Pozostań w kontakcie z naszym zgromadzeniem, niezależnie od miejsca i czasu.",
    ...
    "donations.desc":
      "Twoje wsparcie pomaga nam głosić Ewangelię i służyć społeczności. Dziękujemy za Wasze darowizny!",
    ...
    "contact.desc":
      "Napisz do nas lub odwiedź nas podczas najbliższego nabożeństwa.",
    ...
    "contact.error":
      '✗ Coś poszło nie tak. Spróbuj ponownie lub napisz bezpośrednio na <a href="mailto:info@kztg.pl" class="underline">info@kztg.pl</a>.',
    ...
    "contact.mapCookieDesc":
      "Jeśli się nie zgadzasz, mapa nie zostanie załadowana. Nadal możesz użyć przycisku nawigacji poniżej.",
    ...
    "cookie.bannerDesc":
      "Korzystamy z niezbędnych cookie do działania strony oraz opcjonalnych (np. mapa Google), aby ją ulepszać.",
    "cookie.reject": "Nie zgadzam się",
    "cookie.accept": "Akceptuję",
  },
  en: {
    "page.title":
      "Church of the Risen One in Tarnowskie Góry | Church of the Risen One in Tarnowskie Góry",
    ...
    "radio.desc":
      "Worship music, sermons and live streams from Tarnowskie Góry. Stay connected with our congregation, wherever you are.",
    ...
    "donations.desc":
      "Your support helps us spread the Gospel and serve the community. Thank you for your donations!",
    "donations.recipient": "Recipient",
    "donations.account": "Account number",
    "donations.transferTitle": "Transfer title",
    "donations.purpose": "Darowizna na cele religijne",
    ...
    "contact.error":
      '✗ Something went wrong. Please try again or write directly to <a href="mailto:info@kztg.pl" class="underline">info@kztg.pl</a>.',
    ...
    "contact.mapCookieDesc":
      "If you disagree, the map will not be loaded. You can still use the navigation button below.",
  ...
  uk: {
    "page.title":
      "Церква Воскреслого в Тарновських Горах | Церква Воскреслого в Тарновських Горах",
    ...
    "radio.desc":
      "Музика прославлення, проповіді та пряма трансляція з Тарновських Гір. Залишайтесь на зв'язку з нашою громадою, незалежно від місця і часу.",
    ...
    "donations.desc":
      "Ваша підтримка допомагає нам проповідувати Євангеліє і служити громаді. Дякуємо за ваші пожертви!",
    ...
    "contact.desc":
      "Напишіть нам або відвідайте нас під час найближчого богослужіння.",
    ...
    "contact.error":
      '✗ Щось пішло не так. Спробуйте ще раз або напишіть безпосередньо на <a href="mailto:info@kztg.pl" class="underline">info@kztg.pl</a>.',
    ...
    "contact.mapCookieDesc":
      "Якщо ви не погоджуєтесь, карта не буде завантажена. Ви все одно можете скористатися кнопкою навігації нижче.",
  ...
  ta: {
    "page.title":
      "டர்னோவ்ஸ்கி கோரியில் உயிர்த்தெழுந்தவர் திருச்சபை | டர்னோவ்ஸ்கி கோரியில் உயிர்த்தெழுந்தவர் திருச்சபை",
    "site.name": "டர்னோவ்ஸ்கி கோரியில் உயிர்த்தெழுந்தவர் திருச்சபை",
    "site.name.mobile":
      "டர்னோவ்ஸ்கி கோரியில்<br />உயிர்த்தெழுந்தவர்<br />திருச்சபை",
    "radio.label": "இணைய வானொலி",
    "radio.heading": "எந்நேரமும் கேளுங்கள்",
    "radio.desc":
      "டர்னோவ்ஸ்கி கோரியிலிருந்து வழிபாட்டு இசை, பிரசங்கங்கள் மற்றும் நேரடி ஒளிபரப்பு. எங்கிருந்தாலும் எங்கள் சபையுடன் தொடர்பில் இருங்கள்.",
    ...
    "sermons.desc":
      "எங்கள் வழிபாட்டிலிருந்து சமீபத்திய பிரசங்கங்களைக் கேளுங்கள்.",
    ...
    "donations.desc":
      "உங்கள் ஆதரவு நற்செய்தியை பிரசங்கிக்க மற்றும் சமுதாயத்திற்கு சேவை செய்ய உதவுகிறது. உங்கள் நன்கொடைகளுக்கு நன்றி!",
    ...
    "contact.desc":
      "எங்களுக்கு எழுதுங்கள் அல்லது அடுத்த வழிபாட்டின்போது வாருங்கள்.",
    ...
    "contact.error":
      '✗ ஏதோ தவறு நடந்தது. மீண்டும் முயற்சிக்கவும் அல்லது நேரடியாக <a href="mailto:info@kztg.pl" class="underline">info@kztg.pl</a> என்ற முகவரியில் எழுதவும்.',
    ...
    "contact.mapCookieTitle":
      "Google Maps விருப்பத்தேர்வு குக்கீகளை தேவைப்படுகிறது",
    "contact.mapCookieDesc":
      "நீங்கள் ஒப்புக்கொள்ளவில்லை என்றால், வரைபடம் ஏற்றப்படாது. கீழே உள்ள வழிசெலுத்தல் பொத்தானை பயன்படுத்தலாம்.",
    "contact.mapAccept": "ஏற்றுக்கொண்டு வரைபடம் காட்டு",
    "contact.mapIframeTitle": "Google வரைபடம்",
    "footer.copyright":
      "© 2026 டர்னோவ்ஸ்கி கோரியில் உயிர்த்தெழுந்தவர் திருச்சபை",
